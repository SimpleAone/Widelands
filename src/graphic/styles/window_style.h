...
struct WindowStyleInfo {
	...
	[[nodiscard]] int top_border_thickness() const {
		return border_top_ != nullptr ? border_top_->height() : 0;
	}
	[[nodiscard]] int bottom_border_thickness() const {
		return border_bottom_ != nullptr ? border_bottom_->height() : 0;
	}
	[[nodiscard]] int left_border_thickness() const {
		return border_left_ != nullptr ? border_left_->width() : 0;
	}
	[[nodiscard]] int right_border_thickness() const {
		return border_right_ != nullptr ? border_right_->width() : 0;
	}
