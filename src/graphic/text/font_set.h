...
struct FontSet {
	...
	/// Create a fontset from an already loaded i18n/fonts.lua table.
	FontSet(const std::string& fontset_name, LuaTable& fonts_table);
...
private:
	...
	void parse_fontset(const std::string& fontset_name, LuaTable& fonts_table);
