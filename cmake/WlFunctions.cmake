...
macro(_common_compile_tasks)
  ...
  if(ARG_USES_OPENGL)
    if(OPTION_AMIGAOS4_VIRTIO_GL)
      # Entry points are supplied by src/graphic/virtio and linked through
      # the normal Widelands target dependency graph.
    elseif(OPTION_USE_GLBINDING)
    ...
    if(NOT OPTION_AMIGAOS4_VIRTIO_GL)
  ...
  if(ARG_USES_ICU AND OPTION_USE_ICU)
